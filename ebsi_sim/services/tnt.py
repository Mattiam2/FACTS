...
class TntService:
    ...
    def createDocument(self, *, documentHash: str, documentMetadata: str, didEbsiCreator: str,
                       timestamp: str | None = None, timestampProof: str | None = None):
    ...
    def removeDocument(self, *, documentHash: bytes):
        ...
        self.document_repository.delete(id=document_hash_str)
    ...
    def grantAccess(self, *, documentHash: str, grantedByAccount: str, subjectAccount: str, permission: str):
        ...
        self.access_repository.create(subject=subject, document_id=documentHash, granted_by=granted_by,
    ...
    def revokeAccess(self, *, documentHash: str, revokedByAccount: str, subjectAccount: str, permission: str):
        ...
        subject = bytes.fromhex(subjectAccount[2:]).decode('utf-8')
        permission = "write" if int(permission, 0) else "delegate"
        revoked_access = self.access_repository.list(subject=subject, document_id=documentHash, permission=permission)[
            0]
