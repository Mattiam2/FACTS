...
class PageLinksPublic(SQLModel):
    ...
    first: str | None = Field(default=None, description="URI of the first page")
    prev: str | None = Field(default=None, description="URI of the previous page")
    next: str | None = Field(default=None, description="URI of the next page")
    last: str | None = Field(default=None, description="URI of the last page")
