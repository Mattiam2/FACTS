...
class Settings(BaseSettings):
    ...
    # HS256 JWT CONFIGURATION
    AUTH_SECRET_KEY: str = "secret"
    AUTH_TOKEN_EXPIRE_MINUTES: int = 60

    # Root URL of the EBSI API's
    ...
    # ES256K PUBLIC AND PRIVATE KEYS OF FACTS ISSUER AUTHORITY
    ...
    # FACTS ISSUER VERIFICATION METHOD FOR AUTHENTICATION
    ...
    # ES256 PUBLIC AND PRIVATE KEYS OF FACTS ISSUER FOR VERIFIABLE CREDENTIAL SIGNING
    ...
    # FACTS ISSUER VERIFICATION METHOD FOR VERIFIABLE CREDENTIAL SIGNING
